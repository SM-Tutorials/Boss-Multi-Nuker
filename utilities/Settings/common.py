...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str}Boss-Nuker     |    Made by ₳Đł₮Ɏ₳™ ᴮᵒˢˢ#2302    |    Tokens: [{counttokens}]")
    elif system == 'posix':
        sys.stdout.write(f"{_str}Boss-Nuker     |    Made by ₳Đł₮Ɏ₳™ ᴮᵒˢˢ#2302   |    Tokens: [{counttokens}]")
    else:
        pass
...
banner = r'''
        ...
        ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝╚═╝  ╚═══╝╚══════╝
            ...
            Github.com/Aditya-op > B0.4.3KI Version <

'''
System.Size(120, 30)
System.Clear()
Anime.Fade(Center.Center(banner), Colors.red_to_blue, Colorate.Vertical, interval=0.025, enter=True)